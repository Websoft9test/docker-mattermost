...
The following are the minimal [recommended requirements](https://github.com/mattermost/mattermost-docker):
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r mattermost
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r mattermost -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-mattermost
...
#### Is the item MM_SQLSETTINGS_DATASOURCE need for Mattermost container?  
Yes, otherwise Mattermost can't connect MySQL  
...
| --- | --- | --- | --- |
| mattermost-server | 9001 | Browser access to mattermost Document by http | Y |
## Documentation

[Mattermost Administrator Guide](https://support.websoft9.com/docs/mattermost)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Mattermost Enterprise Support](https://apps.websoft9.com/mattermost) 
